...
//setEvent(ID, PortC_State(Trigger, I, Q, Read, transfer) , rc, nextID);
  ...
  setEvent(3,PortC_State(0,0,0,0,0), Tdeadtime, 4); 
  setEvent(4,PortC_State(0,0,0,1,0), TreadoutF, 5); 
  setEvent(5,PortC_State(0,0,0,0,1), T_transferF, 6); 
  setEvent(6,PortC_State(0,0,0,0,0), Tres, runMode);
  return(0);      // success
}
